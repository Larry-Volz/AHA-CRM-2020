...
(client_id, cc_type, cc_number, cc_expiration_date, ck_routing_number, ck_account_number, ck_number, xaction_status, date, amount) VALUES ('$client_id', '$cc_type', '$cc_number', '$cc_expiration_date', '$ck_routing_number', '$ck_account_number', '$ck_number', '$xaction_status', '$charge_date', '$amount_to_charge')";

 $results = mysql_query($sql);// or die(mysql_error());

/*

???????????????????????/// DO TYPE OF PROGRAM NUMBER, WHAT IS OWED, NUMBER OF PYAMENTS ETC 
														IN FINANCIAL LOG!!!                 ?????????????????????
