...
<table border="0" width="100%" id="table2" style="font-family: Verdana;">
        <tr>
                <td bgcolor="#FFFFFF" bordercolor="#FFFFFF" style="font-family: Verdana;">
                <p align="center">
                <iframe name="I1" src="Igor_Walks_Off.htm" width="127" height="115" scrolling="no">
                Your browser does not support inline frames or is currently configured not to display inline frames.
                </iframe></td>
                <td align="center" bgcolor="#FFFFFF" bordercolor="#FFFFFF" style="font-family: Verdana;"><b><font size="6" color="#000080">Igor</font><font size="4"><br>
</font></b><i><font size="4">The PCs Assistant</font></i></td>
                <td bgcolor="#FFFFFF" bordercolor="#FFFFFF" style="font-family: Verdana;">
                <p align="center"><font size="0">v. 1.6<br>
                (c) Larry Volz<br>
                All Rights Reserved</font></td>
        </tr>
</table>

<table border="0" width="100%" id="table1" cellspacing="0" cellpadding="2" style="font-family: Verdana;" bgcolor=#F0F0F0>
        <tr>
                <td width="45%" height="119" style="font-family: Verdana;">
...
<select size="5" name="program_index" onchange ="reset_payments(); populatepayments(this); calculate_program_costs()"> <!-- find out how to manipulate data for "multiple"-->
                ...
                <td width="23%" bgcolor="#9999FF" align="left" height="119" style="font-family: Verdana; line-height:23px;">
                <p align="right" style="font-size:12px;"><b>Program Price $</b><br>
                Est. # of Sessions</td>
                <td bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF" align="left" height="119" style="font-family: Verdana;">
                <input name="price_display" value = 0 size="7" style="font-weight: 700; float:left" readonly="readonly" onfocus="this.blur()">
                <p style="font-size:25px;"><input name="num_sessions_display" value = "0" size="7" style="font-weight: 700; float:left" readonly="readonly" onfocus="this.blur()" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                <td style="font-family: Verdana;" width="19%" bgcolor="#C0C0C0" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" bordercolordark="#C0C0C0" align="center" height="119" colspan="2">
                <font style="font-size:12px">After Deposit Leaves...</font><b><font style="font-size:12px">
                </font>&nbsp;</b><input name="num_payments_display" value = "0" size="2        " style="font-weight: 700" readonly="readonly" onfocus="this.blur()" ><b> </b>
                <font style="font-size:12px">equal monthly payments
                of $</font><input name="payment_display" value = "0" size="7" style="font-weight: 700" readonly="readonly" onfocus="this.blur()" ></td>
        </tr>
        <tr>
                <td width="45%" style="font-family: Verdana;">
                <font color="#000080" style="font-size:12px;">
                $<input name="deposit" value = "100" size="7" style="font-weight: 700" onchange ="calculate_program_costs()" >
                Deposit <i><font size="2px">(min $100)</font></i></font><p style="font-size:12px;">
                &nbsp;
...
<!--        <select size="1" name="num_payments" onchange ="calculate_program_costs()">
        ...
        Number of Payments Planned</td>
                <td width="23%" bgcolor="#9999FF" align="right" style="font-size:12px; line-height:23px;">Finance Charge <i><font size="2">
                <br>
                (Applied after $100 deposit)</font></i></td>
                <td width="11%" bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF" style="font-size:12px;">
                &nbsp;
        ...
        <font size="2">(Maximum of</font> </i>
                ...
                <font style="font-size:12px;">payments allowed for this goal)</font></i></font></td>
                <td align="right" bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF">
                <font color="#000080">
                <b><font style="font-size:12px;">With This Discount You Save</font></b>:&nbsp; </font> </td>
                ...
                <td width="19%" align="right" bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF" colspan="2" style="font-size:12px;">
                &nbsp;</td>
        </tr>
        <tr>
                <td width="45%">
        &nbsp;</td>
                <td align="right" bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF">
                <font size="2" color="#000080" style="font-size:12px;"><b>Savings From Paying in </b></font>
                <font color="#000080">
                <b><font size="2" style="font-size:12px;">Full
                </font> </b></font></td>
                <td width="11%" bgcolor="#9999FF" bordercolor="#9999FF" bordercolorlight="#9999FF" bordercolordark="#9999FF">
...
<!--        <input type="text" name="discount"  size="2" value="0" onchange ="calculate_program_costs()">%&nbsp; Discount -->
        <select size="1" name="discount" onchange ="calculate_program_costs()">
                ...
                <i><font size="2" style="font-size:12px;">Commission </font></i></td>
        </tr>
        <tr>
                ...
                <p align="center">
                <i><font size="2" style="font-size:12px;">5%</font></i></td>
        </tr>
        <tr>
                <td width="45%">
        &nbsp;</td>
                <td width="23%" bgcolor="#9999FF" align="right" valign="top" style="font-size:12px;">
                <br>
        ...
        <tr>
                <td width="45%" height="48" style="font-size:12px;">
        <input type="checkbox" name="medicare_yesno" value="medicareYES" onchange ="calculate_program_costs()">
&nbsp;Medicare Client? <i><font size="2" style="font-size:12px;"><br>
...
<p align="center"><strong><font size="4" style="font-size:16px;">
Sale Confirmation Information</strong></font><br>
<font color="#FF0000" style="font-size:12px;">*Igor automatically charges the deposit.&nbsp; If client is paying more than $100 up-front, put that amount in deposit field.</font>
</p>

<table border="1" width="100%" id="table3" style="font-size:12px;" bgcolor=#F0F0F0>
        <tr>
                <td width="252" >Client ID# : 
				<font style="font-size: 10px" color="#FF0000">(please cut and 
				paste to avoid errors)</font><br> 
                
                <? if (!empty($_GET['client_id'])) $value= $_GET['client_id']; else $value=""; ?>
				<input type="text" name="client_id" size="24" value="<?=$value ?>"></td>
                
                <? if (!empty($_GET['f_name'])) $value= $_GET['f_name']; else $value=""; ?>
                <td width="232">Client First Name:<input type="text" name="f_name" size="24" value="<?=$value ?>"></td>
                
                <? if (!empty($_GET['l_name'])) $value= $_GET['l_name']; else $value=""; ?>
                <td>Client Last Name:<br>
                <input type="text" name="l_name" size="25" value="<?=$value ?>"></tr>
        <tr>    
                <? if (!empty($_GET['email'])) $value= stripslashes($_GET['email']); else $value=""; ?>
                <td width="252">Client e-mail:<br>
                <input type="text" name="email" size="28" value="<?=$value ?>"></td>

                </td>
<? $query_cc = mysql_query("select * from financial where client_id=".$_GET['client_id']); 
   $cc = mysql_fetch_array($query_cc);  
   $apt_date=$cc['apt_date'];  
   $apt_date_month= date("m","".$apt_date."");
   $apt_date_day= date("d","".$apt_date."");
   $apt_date_year= date("Y","".$apt_date."");
   $apt_date_month2= date("F","".$apt_date."");
   ?>
                <td width="232">Appt. Date:<br>

<select name="months">
           <option value="">Month</option>
                     <?  if ($apt_date_day != '31' && $apt_date_month!= '12' && $apt_date_year!='1969')
                     echo '<option value="'.$apt_date_month.'" selected>'.$apt_date_month2.'</option>
...
<select name="days">
       <option>Day</option>
                    <?  if ($apt_date_day != '31' && $apt_date_month!= '12' && $apt_date_year!='1969')
                     echo '<option value="'.$apt_date_day.'" selected>'.$apt_date_day.'</option>
...
<select name="year">
        <option value="">Year</option>
                    <?  if ($apt_date_day != '31' && $apt_date_month!= '12' && $apt_date_year!='1969')
                     echo "<option value='".$apt_date_year."' selected>".$apt_date_year."</option>
        ...
        <tr>
                <td colspan="3">Affiliate:<br>
                        ...
                        $acIncludes->dbConnect();//connects to db
                               ...
                               if ( $_GET['affiliate']=='0' || $_GET['affiliate']=='')
                               $affiliate = $cc['therapist_id']; 
                               else
                               $affiliate = $_GET['affiliate_id']; 
                                
                                
                                $query_vl= mysql_query("select * from $desc_table where id=".$affiliate."");
                                $fetch_vl = mysql_fetch_array($query_vl);
                                 if( $fetch_vl['l_name'] != '' || $fetch_vl['f_name'] != '')
                                $output .= "<option value='".$therapist_number."' selected>".$fetch_vl['l_name'].", ".$fetch_vl['f_name']." -- ".$fetch_vl['address2'].", ".$fetch_vl['address3']."</option>";
        ...
        <tr>
        	<td>
                ...
                <? if ($cc['cc_type']== 'visa')
        		   ...
        		   if($cc['cc_type']== 'mc')
                      echo '<option value="mc" selected>Master Card</option>';
                   else
                      echo '<option value="mc">Master Card</option>'; 
        		   if($cc['cc_type']== 'amex')
                      echo '<option value="amex" selected>American Express</option>';
                   else
                      echo '<option value="amex">American Express</option> ';
                   if($cc['cc_type']=='discover')
        	...
        	<td>
        		...
        		<input type="text" name ="cc_number" value="<?=$cc['cc_number'] ?>">
        	</td>
        	<td>
<?  
   $cc_expiration_date_month= date("m","".$cc['cc_expiration_date']."");
   $cc_expiration_date_day= date("d","".$cc['cc_expiration_date']."");
   $cc_expiration_date_year= date("Y","".$cc['cc_expiration_date']."");
   $cc_expiration_date_month2= date("F","".$cc['cc_expiration_date'].""); ?>
        		Expiration Date:<br>
        		<select name="cc_expiration_month">
        <option value="">Month</option>
        <?  if ($cc_expiration_date_day != '31' && $cc_expiration_date_month!= '12' && $cc_expiration_date_year!='1969')
                     echo '<option value="'.$cc_expiration_date_month.'" selected>'.$cc_expiration_date_month2.'</option>
        <option value="1">January</option>
        <option value="2">February</option>
        <option value="3">March</option>
        <option value="4">April</option>
...
<select name="cc_expiration_year">
        <option value="">Year</option>
         <? if ($cc_expiration_date_day != '31' && $cc_expiration_date_month!= '12' && $cc_expiration_date_year!='1969')
                     echo "<option value='".$cc_expiration_date_year."' selected>".$cc_expiration_date_year."</option>
        <option value=2006>2006</option>
        <option value=2007>2007</option>
        <option value=2008>2008</option>         
        <option value=2009>2009</option>
        ...
        <tr>
        	<td>
        		Check Routing #:<br>
        		<input type="text" name="ck_routing_number" value="<?=$cc['ck_routing_number'] ?>">
        	</td>
        	<td>
        		Checking Account #:<br>
        		<input type="text" name="ck_account_number" value="<?=$cc['ck_account_number'] ?>">
        	</td>
        	<td>
        		Check #:<br>	
        		<input type="text" name="ck_number" value="<?=$cc['ck_number'] ?>">
        	</td>  
        </tr>
        
<!-- ########################## DATE SOLD SELECT BOX AND PAPERWORK ONLY CHECK BOX ###########################  -->        
        <tr>
        	<td colspan="3">
        		Date Sold: <br>
					...
					<?  /*
						$box_name="date_sold";
						$ds_month_select= $time_travel->TodayMonthSelectBox($box_name);
						echo $ds_month_select;
						$ds_day_select = $time_travel->TodayDaySelectBox($box_name);
						echo $ds_day_select;
						$ds_year_select = $time_travel->TodayYearSelectBox($box_name);
						echo $ds_year_select;				
					*/		
					?>  
 <?
 $date_sold_month= date("m","".$cc['date_sold']."");
   $date_sold_day= date("d","".$cc['date_sold']."");
   $date_sold_year= date("Y","".$cc['date_sold']."");
   $date_sold_month2= date("F","".$cc['date_sold'].""); ?>
                <select name="date_sold_month">
        <option value="">Month</option>
        <?  if ($date_sold_day != '31' && $date_sold_month!= '12' && $date_sold_year!='1969')
                     echo '<option value="'.$date_sold_month.'" selected>'.$date_sold_month2.'</option>
        <option value="1">January</option>
        <option value="2">February</option>
        <option value="3">March</option>
        <option value="4">April</option>
        ...
        <option value="12">December</option>
             ...
             echo  '<select name="date_sold_day" onchange="format_sales_contact_next();" size="1">
                    <option>Day</option>  '; 
                      if ($date_sold_day != '31' && $date_sold_month!= '12' && $date_sold_year!='1969')
                     echo '<option value="'.$date_sold_day.'" selected>'.$date_sold_day.'</option> 
        <option value="1">1</option>
        <option value="2">2</option>
        <option value="3">3</option>
        <option value="4">4</option>
...
echo '<select name="date_sold_year">
        <option value="">Year</option>';
          if ($date_sold_day != '31' && $date_sold_month!= '12' && $date_sold_year!='1969')
                     echo "<option value='".$date_sold_year."' selected>".$date_sold_year."</option>
        <option value=2006>2006</option>
        <option value=2007>2007</option>
        <option value=2008>2008</option>         
        <option value=2009>2009</option>
        ...
        <option value=2019>2019</option>
        <option value=2020>2020</option>";    ?>    
			<input type="hidden" name="date_sold_hour" value = "
				<?
				$date_sold_hour=date("H");
				echo $date_sold_hour;
				
				?>
			">	 
			<input type="hidden" name="date_sold_minute" value = "
				<?
				$date_sold_minute=date("i");
				echo $date_sold_minute;
...
<font color="#FF0000" style="font-size:10px">(Otherwise deposit is applied today.)</font>
        	</td>
        </tr>
        <tr>
        	<td colspan="3">
...
<!-- ################################## OVERRIDE EXP DATE CHECK BOX ################################ -->			  
			<td colspan="2">
				<input type="checkbox" name="override_cc_exp" value="checked">Override CC Expiration Date
			</td>
		</tr>     
</table>
<p align="center">
