...
//define program description variables (include from Igor_variables if needed to update)					
...
<? 
//build the complete text from individual paperwork
...
//add universal letters to output string
