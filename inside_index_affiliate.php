...
<table border="0" width="100%" id="table1">
	<tr>
		...
		larry@americanhypnosisclinic.com</a></p>
			...
			<br>Testing:
			<br>Session Variable: auth = <? echo $auth; ?>
			<br>Session name = <? echo session_name(); ?>
			
		</td>
		<td width="325" style="border: 6px ridge #C0C0C0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" valign="top">
	&nbsp;<br><br><br><br>

	
<script type="text/javascript" language="JavaScript1.2" src="http://www.americanhypnosisclinic.com/ajlib.js"></script>
<script type="text/javascript" language="JavaScript1.2" src="http://www.americanhypnosisclinic.com/ajscroller.js"></script>
<script type="text/javascript" language="JavaScript1.2" src="http://www.americanhypnosisclinic.com/testimonials3.js"></script>
