...
}// close the while/assigning variables loop
...
<html>
<head>
<title>AHC Contacts: Delete a Contact</title>
<meta name="Microsoft Border" content="r, default">
</head>
<body><!--msnavigation--><table dir="ltr" border="0" cellpadding="0" cellspacing="0" width="100%"><tr><!--msnavigation--><td valign="top">
<h1>AHC Contacts<h1>
<h2><em>Delete a Contact</em></h2>
<FORM METHOD="post" action = "do_mc_delcontact.php">
...
<input type="text" name="title" value="<? echo "$title"; ?>" size="35" maxlength="100"></p>
<p><strong>Company:</strong><br />
<input type="text" name="company" value="<? echo "$company"; ?>" size="35" maxlength="100"></p>
<p><strong>Website:</strong><br />
<input type="text" name="website" value="<? echo "$website"; ?>" size="35" maxlength="100"></p>
...
<input type="text" name="sec_tel" value="<? echo "$sec_tel"; ?>" size="35" maxlength="35"></p>

<p><strong>Mobile Phone:</strong><br />
<input type="text" name="mob_tel" value="<? echo "$mob_tel"; ?>" size="35" maxlength="35"></p>
