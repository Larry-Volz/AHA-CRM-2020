...
//do log entry
$now=time();
$list_id=14; //code for 'add a person' - PUT IN CORRECT CODE FOR PAGE!
...
//############################# create output table with table helper ###########################################
...
$sql="SELECT id,f_name,l_name,company,address2,address3 FROM $table_name WHERE membership_status = 'Lead' ORDER BY address3";
...
$contact_list="<table border=\"1\"><ul>";
	...
	while ($row = mysql_fetch_array($result)){
        ...
        $contact_list .= "<tr><td><li>$address3 ($address2):</td><td>  <a href=\"show_affiliate.php?id=$id\">$f_name $l_name - $company</a></td></tr>";
...
<head>
  <title>American Hypnosis Clinic:  Affiliate Leads Listed By State</title>
