...
global $affil_id;
$affil_id = $_GET['id'];//WORKS!!  MOST IMPORTANT PART, EH
  ...
  //    $ahcDB->getAffiliatesVars($id); is SUPPOSED to replace below.  Doesn't give variables back...
       ...
       // echo $sql;
        ...
        while ($row=$DB->fetchArray())
        {
            ...
            $address_physical = $row['address_physical'];
...
<font size="2"><br>
            <INPUT TYPE="text" NAME="address_physical"  value="<? echo $address_physical; ?>"  SIZE="84" CLASS="SGResponse"></font><font face="Arial" size="2">
</font></P>
          </TD>
        </TR>
      </TABLE>  
...
<br>
            <INPUT TYPE="text" NAME="physical_city" SIZE="35" CLASS="SGResponse" value="<? echo $physical_city; ?>"></font></P>
          </TD>
          <TD WIDTH="28%">
...
$state_print = "<select name=\"physical_state\">";

    for ($i=0; $i<50; $i++){
      
         $state_print .= $state_left_string[$i];
         
            if ($state_abbrevs[$i] == $physical_state){
...
?>
          ...
          <TD WIDTH="38%">
            ...
            <INPUT TYPE="text" NAME="physical_zip" SIZE="14" CLASS="SGResponse" value="<? echo $physical_zip; ?>"></font></TD>
        </TR>
      </TABLE>      
...
<font size="2"><span style="font-weight: 400">Tax ID number</span><br>
            <INPUT TYPE="text" NAME="tax_id" SIZE="46" CLASS="SGResponse"  value="<? echo $tax_id; ?>" ><br>
&nbsp;</font></P>
          </TD>
        </TR>
      </TABLE>      
...
?>   
		...
		<td>Rating<br>
		<input type="text" name="ranking" size="3" value="<? echo "$ranking"; ?>" </td ?>"</td>
...
<?
	$print_sched_meth ="<tr><td>Scheduling Method:<br>";
	
	$print_sched_meth .= "<select name=\"scheduling_method\">";
	
		$print_sched_meth .="<option value=\"Pick One\"";	
		if ($scheduling_method == "Pick One"){
		  $print_sched_meth .=" selected";
		}
...
//------------------------------------------------	
		...
		if ($scheduling_method == "Schedule 1st - ask later"){
		  $print_sched_meth .=" selected";
		}	
	$print_sched_meth .= ">Schedule 1st - ask later</option>";
//---------------------------------------------------------	


	$print_sched_meth .="<option value=\"Yahoo Calendar\"";	
		if ($scheduling_method == "Yahoo Calendar"){
		  $print_sched_meth .=" selected";
		}
...
//------------------------------------
	$print_sched_meth .= "<option value=\"Call & Get Availability\" ";
		if ($scheduling_method == "Call & Get Availability"){
		  $print_sched_meth .= " selected";
		}	
...
<!-- -------------------------------------------------------------------  -->		
	...
	<td>
		Reserved Appointment Times:<br> <input type="text" value="<? echo $rsvp_apt_times; ?>" name="rsvp_apt_times" />		
	</td>
	<td>
		Office Hours:<br> <input type="text" value="<? echo $office_hours; ?>" name="office_hours" />
	</td>
</tr>
<tr>
	<td>
		Online Calendar:<br><input type="text" value="<? echo $online_calendar; ?>" name="online_calendar" />
	</td>
	<td>
		Username:<br><input type="text" value="<? echo $calendar_user_name; ?>" name="calendar_user_name" />
	</td>
	<td>
		Password:<br><input type="text" value="<? echo $calendar_password; ?>" name="calendar_password" />
	</td>
	</tr>
	</table>
