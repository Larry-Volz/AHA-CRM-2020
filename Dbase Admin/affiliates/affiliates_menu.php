...
<br><i><font size="3"><a href="show_affiliatesbystate.php">By State</a> - <a href="show_affiliatesbylname.php">By Last Name</a> - <a href="show_affiliatesbyorg.php">By Clinic Name</a> 
<br><a href="show_affiliatesbystartdate.php">By Date Created</a></font></i><br>
</p>
<br>
...
<table border="1" width="102%" id="table3">
    <tr>
        <td>
        <p align="center">Search Therapist</p>
        <form method="POST" action="show_search_results.php">

            <input type="hidden" value="1"><!-- PUT CLIENT ID # HERE FROM SENDING PAGE!!! -->

            <p align="center">Affiliate first name:<br>
            <input type="text" name="first_name" size="20"></p>
            <p align="center">Affiliate last name:<br>
            <input type="text" name="last_name" size="20"></p>            
            <p align="center">Email:<br>
            <input type="text" name="s_email" size="20"></p>  
