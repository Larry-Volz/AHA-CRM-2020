...
//do log entry
$now=time();
$list_id=19; //code for 'add a person' - PUT IN CORRECT CODE FOR PAGE!
...
$sql="SELECT id,f_name,l_name,company,address2,address3 FROM $table_name WHERE membership_status = 'Pending Contract' ORDER BY address3";
...
<head>
  <title>American Hypnosis Clinic:  Pending Affiliates Listed By Name</title>
<meta name="Microsoft Border" content="r, default">
</head>

<body><!--msnavigation--><table dir="ltr" border="0" cellpadding="0" cellspacing="0" width="100%"><tr><!--msnavigation--><td valign="top">
<h1>PENDING Affiliates<br>
