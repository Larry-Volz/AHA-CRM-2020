...
<body>
<form method="POST" name = "modify_affiliate_form" action="show_modaffiliate.php?affil_id=$affil_id">
	<input type="hidden" name = "affil_id" value="<? echo "$affil_id"; ?>" <table rowspan="2" ?>" <table rowspan="2" ?>" <table rowspan="2" ?>" <table rowspan="2" ?>" <table rowspan="2" ?>" <table rowspan="2"> <table rowspan="2"> <table cellspacing="3" cellpadding = "3">
...
<? 
		...
		echo "<td width=\"35\"><img src=\"$ranking stars.jpg\"></td>";
}//end
...
if ($company != ""){
	...
	echo "<br>";
	echo "<table border=\"1\" valign=\"top\"cellspacing=\"3\" cellpadding=\"3\" widthe=\"100%\"><tr><td>";
		
echo "Certifications: $cert_print_block";
