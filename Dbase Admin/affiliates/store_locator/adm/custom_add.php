...
IF(isset($_POST['Submit']))
{
	...
	mysql_query("ALTER TABLE `stores_custom` ADD `" . $_POST['field'] . "` VARCHAR( 255 ) NOT NULL ;");	log_action('Added Custom Field');
	transfer('custom_edit.php','Added Custom Field');
	exit;
}
?>
...
<html>
<head>
<title>Store Locator Admin Panel - Add Custom Field</title>
...
<table align="center" width="850" cellpadding="0" cellspacing="0" border="0">
<tr>
<td class="heading">Add Custom Field </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<table align="center" width="850" border="0" cellpadding="0" cellspacing="0" bgcolor="#F6F6F6" style="border:1px solid #CCCCCC;">
    <tr>
      <td><br>        <table width="50%"  border="0" align="center" cellpadding="4" cellspacing="0">
        <tr>
          <td width="50%" valign="middle" class="style5"><strong>Field Name:</strong></td>
          <td>
            <input name="field" type="text" size="30" id="field">          </td>
        </tr>
      </table>              </td>
    </tr>
    <tr>
