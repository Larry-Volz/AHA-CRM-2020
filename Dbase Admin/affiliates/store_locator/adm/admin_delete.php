...
IF(isset($_POST['Submit']))
{
	...
	mysql_query($sql);	log_action('Deleted Admin');
	transfer('admin_edit.php','Deleted Admin');
	exit;
}
ELSE
{
...
<table align="center" width="850" cellpadding="0" cellspacing="0" border="0">
<tr>
<td class="heading">Delete Admin </td>
</tr>
<tr>
<td bgcolor="#333333"><img src="images/dot.gif" width="1" height="1" alt=""></td>
</tr>
...
<span class="style6"><span class="style7">Are you sure you want to delete the following admin?</span><br>
              </span><br>
<ul>
<? 
$count = 0;
...
{
	if($info['admin_username']!="admin"){
		echo "<li>" . $info['admin_username'] . "</li>";
