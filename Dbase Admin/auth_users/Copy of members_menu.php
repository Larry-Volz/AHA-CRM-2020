...
//#################### COMMUNICATE THAT PERMISSION TO JAVASCRIPT ####################

$jscript_block = "<script type=\"text/javascript\"><br>var permission = ";
$jscript_block .= $permission ;
$jscript_block .= "</script>";
...
document.write("<h1>Permission =" + permission + "</h1>");
