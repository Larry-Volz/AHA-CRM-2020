...
- First, input data for one program + personal/credit card data
- go to do_Igor_intermediate: which saves data and asks "another program?" and has a "Cancel" option
- if yes -> then to a copy of Igor2 which fills in the personal data (not as inputs) and accepts a second program
- go to do_Igor_intermediate again, and if this time the answer is no then on to do_Igor_paperwork.php which...
- adds the total # of payments together, adds the total $ together, and then divides for an average per month, display that amount and send the paperwork out.
- or displays total and then the paperwork


OR...

Igor and have "add to cart" and "checkout" buttons 

- add to cart brings up Igor again but with a display showing the first purchase
- on "checkout" show both purchases.   Add the total # of payments together, adds the total $ together, and then divides for an average per month, display that amount and credit card input information plus printout/e-mail options.
...
<table border="0" width="100%" id="table2">
	<tr>
		...
		<td bgcolor="#FFFFFF" bordercolor="#FFFFFF">
		<p align="center"><font size="1">v. 2.0<br>
		(c) Larry Volz<br>
...
<h3 align="center">
Paperwork Information</h3>
<table border="0" width="100%" id="table3">
	<tr>
		<td width="252">Client First Name:<input type="text" name="f_name" size="24"></td>
		<td width="232">Client Last Name:<br>
		<input type="text" name="l_name" size="25"></td>
		<td>Client e-mail:<br>
		<input type="text" name="email" size="28"></tr>
	<tr>
		<td width="252">Appt. Date:<br>
...
<select name="year">
	...
	<option value=2016>2016</option>
		...
		<td width="232">Appt. Time:<br>
		<input type="text" name="appointment_time"></td> </td>
		<td>&nbsp;</td>
	</tr>
	<tr>
...
<table border="1">
	<tr>
		...
		<tr>
		<td>
			3-Digit Security Code:<br><input type="text" name="sec_code" width="3" size="3">
		</td>

	</tr>
</table>
<p align="center">
	<input type="radio" value="print" name="print_or_email">Print 
	<input type="radio" value="e-mail" name="print_or_email" checked >E-mail </p>
<p align="center">
<input type="submit" value="Create Paperwork" name="submit_button">
