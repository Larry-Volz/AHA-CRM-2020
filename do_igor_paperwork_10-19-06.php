...
$client_mail_body = "$intro_letter"."<br><br><font color = \"blue\">
  By clicking below I acknowledge that I have read and agree to the terms and conditions in The Lifetime Commitment Guarantee and Client Contract.
  <p align=\"center\"><strong><a href='$email_receipt_url'>I Agree</a></strong>
  <br><br>If clicking the link does not take you to a confirmation page please copy the following link to your favorite browser: $email_receipt_url</p></font> ".$intro_letter_end;
