...
<select name="year">
        ...
        <tr>
                <td width="252">
                <input type="radio" value="Richmond" checked name="rich_or_affil">Richmond
                <input type="radio" value="Affiliate" name="rich_or_affil">Affiliate
                </td>
                <td colspan="2">Affiliate:
                        <?
