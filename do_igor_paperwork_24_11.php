...
$sql.= " VALUES ( '' , $user_id , '$email' , '$client_mail_body' , '$code' , 0 , NOW(), '".$_POST['f_name']."' , '".$_POST['l_name']."', '$client_id' )";
$results2 = mysql_query($sql) or die(mysql_error());
...
//  $htmltopdf->useURL(HKC_USE_EASYW);
  ...
  require("includes/h2pdf/html2fpdf.php");
  error_reporting(0);
...
$complete_text .= "$smoking_letter";
  ...
  $htmlFile = IMAGE_DIR.$htmfilename ;
  ...
  $pdf->Output(IMAGE_DIR.$attach_files[$i++],"F");
