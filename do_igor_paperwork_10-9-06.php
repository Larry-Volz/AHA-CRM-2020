...
(client_id, cc_type, cc_number, cc_expiration_date, ck_routing_number, ck_account_number, ck_number, xaction_status, date, amount, program_id, program_cost, number_of_payments, equal_payments_of) VALUES ('$client_id', '$cc_type', '$cc_number', '$cc_expiration_date', '$ck_routing_number', '$ck_account_number', '$ck_number', '$xaction_status', '$charge_date', '$amount_to_charge', '$program_index', '$total_program_cost', '$number_of_payments', '$equal_payments_of')";
