...
/*
Igor Goals:
- put in form slots for client id#, credit card number, amount, and credit card date to task Meredith
- have it put it in a "charges" database with date charged (time()) and amount
- set up Meredith's main screen to show Charges list with an option to click "charged" or "failed redo" which updates the database and charged accounts are removed from the list.
*/
...
//                        num_payments = document.Igor.num_payments.value //number of payments requested from drop-down
 ...
 //               document.Igor.price_display.value = program_price[program_index] //CORRECT
                ...
                document.Igor.price_display.value = base_price //CORRECT
...
&nbsp;Medicare Client? <i><font size="2"><br>
                (Additional payments possible)</font></i>
...
<p align="center">
        ...
        <input type="radio" value="e-mail" name="print_or_email" checked >E-mail

        </p>      
-->
		
<p align="center">
<input type="button" onclick='validare();'  value="Complete Sale" name="submit_button">

<!-- <input type="submit" value ="Complete Sale" name="submit_button"> -->
